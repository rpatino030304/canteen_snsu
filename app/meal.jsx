...
const mealItems = {
  rice: [
    { id: 1, name: 'PLAIN RICE', price: 50, image: require('../assets/images/meal.png') },
    { id: 2, name: 'FRIED RICE', price: 50, image: require('../assets/images/friedriceegg.png') },
  ],
  dish: [
    { id: 3, name: 'TORTA', price: 50, image: require('../assets/images/icon.png') },
    { id: 4, name: 'FRIED CHICKEN', price: 50, image: require('../assets/images/icon.png') },
    { id: 5, name: 'HAM', price: 50, image: require('../assets/images/icon.png') },
    { id: 6, name: 'HOTDOG', price: 50, image: require('../assets/images/hotdogrice.png') },
    { id: 7, name: 'BOILED EGG', price: 50, image: require('../assets/images/icon.png') },
    { id: 8, name: 'SUNNY SIDE UP', price: 50, image: require('../assets/images/icon.png') },
    { id: 9, name: 'PORK CHOP', price: 50, image: require('../assets/images/icon.png') },
    { id: 10, name: 'FRIED FISH', price: 50, image: require('../assets/images/icon.png') },
  ]
};
