...
const drinkItems = [
  { id: 1, name: 'WATER', price: 50, image: require('../assets/images/drinks.png') },
  { id: 2, name: 'SODA', price: 50, image: require('../assets/images/icon.png') },
  { id: 3, name: 'JUICE', price: 50, image: require('../assets/images/icon.png') },
  { id: 4, name: 'COFFEE', price: 50, image: require('../assets/images/icon.png') },
  { id: 5, name: 'TEA', price: 50, image: require('../assets/images/icon.png') },
  { id: 6, name: 'MILK', price: 50, image: require('../assets/images/icon.png') },
];
