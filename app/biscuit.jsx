...
const biscuitItems = [
  { id: 1, name: 'REBISCO', price: 50, image: require('../assets/images/biscuits.jpg') },
  { id: 2, name: 'CRACKERS', price: 50, image: require('../assets/images/icon.png') },
  { id: 3, name: 'COOKIES', price: 50, image: require('../assets/images/icon.png') },
  { id: 4, name: 'WAFERS', price: 50, image: require('../assets/images/icon.png') },
  { id: 5, name: 'BREAD', price: 50, image: require('../assets/images/icon.png') },
  { id: 6, name: 'CAKE', price: 50, image: require('../assets/images/icon.png') },
];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>BISCUIT</Text>
      </View>
